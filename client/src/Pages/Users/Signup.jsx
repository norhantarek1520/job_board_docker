        ...
        <div className="col-12 col-md-9 col-lg-7 col-xl-6">
            <div className="card"   style={{border:" 15px;"}} >
                <div className="card-body p-5">
                    <h2 className="text-uppercase text-center mb-5">Signup With an account</h2>
                    ...
                    <form action="/login" method="post">
                        ...
                        <p className="text-center text-muted mt-5 mb-0">you have an account? <a
                                href="/registre" className="fw-bold text-body"><u>login
                                    here</u></a></p>
